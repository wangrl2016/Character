...
#include "base/string/utf_string_conversion_util.h"
...
namespace base {
    ...
    // (i.e. bool, char, int or their extended versions) and is of the correct size.
    ...
    bool UTFConversion(const InputString& src_str, DestString* dest_str) {
        ...
        dest_str->resize(src_str.length() * size_coefficient_v<
    ...
    std::string WideToUTF8(WStringPiece wide) {
        std::string ret;
        // Ignore the success flag of this call, it will do the base it can for
