//
// Created by wangrl2016 on 2023/2/19.
//
...
namespace base {
    // auto c0 = 'A';      // char
    // auto c1 = u8'A';    // char (macOS not support)
    // auto c2 = L'A';     // wchar_t
    ...
    const wchar_t* const kConvertRoundtripCases[] = {
            L"Google Video",
            // "网页 图片 资讯更多 »"
            // Unicode lookup: https://www.compart.com/en/unicode/
            // 网(UTF-16 Encoding: 0x7F51, UTF-32 Encoding: 0x00007F51)
            // 页(0x00009875)
            ...
            // Test characters that take more than 16 bits. This wil depend on whether
            // wchar_t is 16 or 32 bits.
#if defined(WCHAR_T_IS_UTF16)
            L"\xd800\xdf00",
            // ◌𑵀◌𑵁◌𑵂◌◌𑵄𑵃 (Mathematical Alphanumeric Symbols (U+011d40 - U+011d44 : A,B,C,D,E)
            // ◌𑵀(0xD807 0xDD40)
    ...
    TEST(UTFStringConversionTest, ConvertUTF8AndWide) {
    ...
    TEST(UTFStringConversionTest, ConvertUTF8AndWideEmptyString) {
    ...
    TEST(UTFStringConversionTest, ConvertUTF8ToWide) {
        struct UTF8ToWideCase {
            ...
            bool success;
                ...
                // Regular UTF-8 input.
                // 你(UTF-8 Encoding: 0xE4 0xBD 0xA0)
                // 好(UTF-8 Encoding: 0xE5 0xA5 0xBD)
                {"\xe4\xbd\xa0\xe5\xa5\xbd", L"\x4f60\x597d", true},
                // Non-character is passed through.
                // Undefined character (U+FFFF)
                {"\xef\xbf\xbfHello", L"\xffffHello", true},
                // Truncated UTF-8 sequence.
                // 0xEF 0xBF 0xBD 0xE5 0xA5 0xBD
    ...
    TEST(UTFStringConversionTest, ConvertUTF16ToUTF8) {
    ...
    TEST(UTFStringConversionTest, ConvertUTF32ToUTF8) {
        struct WideToUTF8Case {
            const wchar_t* utf32;
            const char* utf8;
            bool success;
    ...
    TEST(UTFStringConversionTest, ConvertMultiString) {
